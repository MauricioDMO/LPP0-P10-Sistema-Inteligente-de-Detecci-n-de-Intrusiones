  ...
  return (
    <main className="min-h-screen px-3 py-3 text-foreground sm:px-4 lg:px-6">
      <div className="mx-auto flex max-w-450 flex-col gap-3">
        <PageHeading eyebrow="Geo analytics" title="Geografía y mapa de calor" description="Histórico persistente enriquecido por ubicación para detectar concentración de actividad por país, ciudad e ISP." />
