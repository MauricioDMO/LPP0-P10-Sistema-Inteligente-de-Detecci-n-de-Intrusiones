...
export function SuricataCustomRulesPage() {
  ...
  return (
    <SectionCard eyebrow="Firmas locales" title="Reglas personalizadas" description="Agrega reglas Suricata propias para el perfil seleccionado. Solo las reglas activas y válidas se incluyen al aplicar configuración.">
      ...
      <form className="mb-4" onSubmit={handleCreateCustomRule}>
      ...
      <div className="grid gap-3">
        {customRules.map((rule) => (
          <article className="rounded-xl border border-soc-outline/70 bg-soc-lowest/55 p-3" key={rule.id}>
            ...
            <pre className="mt-3 max-h-44 overflow-auto rounded-lg border border-soc-outline/60 bg-black/25 p-3 font-mono text-[11px] leading-5 text-soc-muted">{rule.rule_text}</pre>
