...
export function SuricataSourcesPage() {
  ...
  return (
    <SectionCard eyebrow="Rulesets" title="Fuentes de reglas" description="Activa las fuentes externas que quieres incluir cuando se ejecute suricata-update. Cambiar un switch prepara el cambio; Suricata se actualiza al aplicar configuración.">
      <div className="mb-4 grid gap-3 lg:grid-cols-[1fr_22rem]">
        <InfoPanel title="Cómo leer esta sección">
          Una fuente activa descarga y compila sus reglas en el próximo apply. Si una fuente genera mucho ruido, desactívala aquí o ajusta reglas concretas desde Overrides.
        </InfoPanel>
        <div className="rounded-xl border border-soc-outline/65 bg-soc-lowest/55 p-3">
      ...
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
        {sources.map((source) => (
          <article className="rounded-xl border border-soc-outline/70 bg-soc-lowest/55 p-3 transition hover:border-soc-primary/35 hover:bg-soc-blue/8" key={source.id}>
            ...
            <div className="mt-4 flex items-center justify-between gap-3 border-t border-soc-outline/50 pt-3">
